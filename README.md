...
## Klipper plugin for a self calibrating Z offset, useful if you have few spring steel sheets with different thickness, this plugin will
adjust every time to your surface/build plate automatically, no need for manual Z offset.
